                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mb-1-6 mb-md-1-9">
                        <article class="card card-style2 border-none">
                            <div class="card-img">
                                <img style="width:100%;height:460px;" src="{{ asset($post->post_feature_image) }}"
                                    alt="..." img-fluid>
                            </div>
                            <div class="blog-info-tag">
                                <div class="text-end"><a href="#!"
                                        class="bg-light-pink">{{ $post->postcategory->postcate_name }}</a></div>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="blog-author">
                                    <div class="blog-author-img">
                                        <img style="height: 80px; width:80px;"
                                            src="{{asset('uploads/user/image/')}}/{{ $users->photo }}" alt="...">
                                    </div>
                                     <span class="text-light-pink">{{ optional($post->creator)->name }}</span>
                                </div>
                            </div>
                        </article>
                    </div>
                ...
                <div class="ps-lg-1-6 ps-xl-1-9">
                    ...
                    <div class="widget">
                        ...
                        <ul class="cat-list">
                            ...
                            <li>
                                <a href="#!">
                                    <i class="fas fa-angle-right"></i>{{ $category->postcate_name}}<span>4</span>
                                </a>
                            </li>
                            @endforeach
                    ...
                    <div class="widget">
                        ...
                        <div class="media mb-3 border-bottom pb-3 border-color-extra-light-gray">
                            ...
                            <div class="media-body align-self-center">
                                <h4 class="h6 mb-1">
                                    <a href="{{ route('blog.detail',$p_post->post_url) }}">{{ $p_post->post_title }}
                                    </a>
                                </h4>
                                <a href="#!" class="small">
                                    <i class="far fa-calendar-check me-2"></i>{{ $p_post->created_at->format('d Y M') }}
                                </a>
                            </div>
                        </div>
                        @endforeach
