                ...
                <div class="posts-wrapper">
                    ...
                    <div class="post-content">
                        <div class="post-meta">
                            <div class="mb-1-6 mb-md-1-9">
                                <img style="width:100%; height:435px;" src="{{ asset($posts->post_feature_image) }}"
                                    alt="..." img-fluid alt="...">
                            </div>
                            <h2 class="h3">{{ $posts->post_title }}</h2>
                        ...
                        <div class="mb-1-6 mb-md-1-9">
                            ...
                            <p class="mb-0">Simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                        ...
                        <div class="row mb-1-6 mb-md-1-9">
                            <div class="col-lg-12">
                                ...
                                <p class="mb-1-6 mb-xl-1-9">It is a long established fact that a reader will be
                                ...
                                <blockquote>
                                    <p class="lead fst-italic font-weight-400 mb-1">
                                        I will let my mum know about this, she could really make use of seo! Your
                        ...
                        <div class="row mb-1-6 mb-md-1-9">
                            ...
                            <div class="col-lg-12">
                                <div class="row g-2">
                                    <div class="col-6">
                                        <img class="rounded"
                                            src="{{asset('contents/forntend')}}/img/blog/blog-detail-05.jpg" alt="...">
                                    </div>
                                    <div class="col-6">
                                        <img class="rounded"
                                            src="{{asset('contents/forntend')}}/img/blog/blog-detail-03.jpg" alt="...">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="author-info-wrapper">
                        ...
                        <div class="author-info-content">
                            ...
                            <p>You won't regret it. I just can't get enough of digital marketing. I want to get a
                                T-Shirt with digital marketing on it so I can show it off to everyone.</p>
                                ...
                                <article class="card card-style2 border-none h-100">
                                    ...
                                    <div class="blog-info-tag">
                                        <div class="text-end"><a href="#!"
                                                class="bg-yellow">{{ $r_post->postcategory->postcate_name }}</a></div>
                                    </div>
                                    <div class="card-body">
                                        <small
                                            class="font-weight-500">{{  $r_post->created_at->format("d Y M")  }}</small>
                                        <h3 class="h4 mt-2 mb-3"><a
                                                href="blog-detail.html">{{ $r_post->post_title }}</a></h3>
                                        <p class="mb-3">{{  Str::limit($r_post->post_details, 200)  }}</p>
                                        <div class="blog-author">
                                            <div class="blog-author-img">
                                                <img style="height: 80px; width:80px;"
                                                    src="{{asset('uploads/user/image/')}}/{{ $users->photo }}"
                                                    alt="...">
                                            </div> <span
                                                class="text-yellow">{{ optional($r_post->creator)->name }}</span>
                                        </div>
                                    </div>
                                </article>
                            </div>
                    ...
                    <div class="comments-area">
                        ...
                        <div class="media border-bottom mb-4 pb-4 border-color-extra-light-gray">
                            <img class="rounded-circle" src="{{asset('contents/forntend')}}/img/avatar/avatar-03.jpg"
                                alt="...">
                        ...
                        <div class="media border-bottom mb-4 pb-4 border-color-extra-light-gray">
                            <img class="rounded-circle" src="{{asset('contents/forntend')}}/img/avatar/avatar-04.jpg"
                                alt="...">
                            <div class="media-body ms-4">
                        ...
                        <div class="media">
                            <img class="rounded-circle" src="{{asset('contents/forntend')}}/img/avatar/avatar-05.jpg"
                                alt="...">
                            <div class="media-body ms-4">
                ...
                <div class="ps-lg-1-6 ps-xl-1-9">
                    <div class="side-bar">
                        ...
                        <div class="widget">
                            ...
                            <ul class="blog-tags ps-0">
                                @foreach ( $tags as $tag)
                                <li><a href="{{ route('show.tag.post.all', $tag->tag_slug) }}">{{ $tag->tag_name }}</a></li>
                                @endforeach
