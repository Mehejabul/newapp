        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-1-6 mb-md-1-9 mb-lg-2-5">
                <article class="card card-style2 border-none h-100">
                    <div class="card-img">
                        <img style="width:100%;" src="{{ asset($post->post_feature_image) }}" alt="...">
                    </div>
                    <div class="blog-info-tag">
                        <div class="text-end"><a href="#" class="bg-light-pink">
                                {{ $post->postcategory->postcate_name }} </a></div>
                    </div>
                    <div class="card-body">
                        <small class="font-weight-500">{{ $post->created_at->format('d M.Y') }}</small>
                        <h3 class="h4 mt-2 mb-3"><a
                                href="{{ route('blog.detail',$post->post_url) }}">{{ $post->post_title }}</a></h3>
