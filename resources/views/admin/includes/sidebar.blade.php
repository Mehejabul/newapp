    ...
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            <li class="sidebar-item active">
                <a href="{{ route('admin.index') }}" class="sidebar-link"> <i class="align-middle"
                        data-feather="home"></i> <span class="align-middle">Dashboards</span> </a>
            </li>
            <li class="sidebar-item">
                ...
                <ul id="pages" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    ...
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('user.create') }}">Create user</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="sidebar-item">
                ...
                <ul id="pagess" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('banner.index') }}">All Banner</a>
                    </li>
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('banner.create') }}">Create
                            Banner</a></li>
                </ul>
            </li>
            ...
            <li class="sidebar-item">
                ...
                <ul id="pagesss" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('manage.basic.index') }}">Basic
                            Setting</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('social.media.index') }}">Social
                            Media</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('contact.index') }}">Contact
                            Information</a></li>
            ...
            <li class="sidebar-item">
                ...
                <ul id="category" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('post.category.index') }}">All post
                            category</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('post.category.create') }}">Create
                            Post Category</a></li>
                </ul>
            </li>
            ...
            <li class="sidebar-item">
                ...
                <ul id="post" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    ...
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('post.create') }}">Create Post</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="sidebar-item">
                ...
                <ul id="tag" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    ...
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('tag.create') }}">Create tag</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="sidebar-item">
                ...
                <ul id="pag" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    ...
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('page.create') }}">Create page</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="sidebar-item">
                ...
                <ul id="content" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('content.index') }}">All content</a>
                    </li>
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('content.create') }}">Create
                            content</a></li>
                </ul>
            </li>
            ...
            <li class="sidebar-item">
                ...
                <ul id="review" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('review.index') }}">All review</a>
                    </li>
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('review.create') }}">Create
                            review</a></li>
                </ul>
            </li>

            <li class="sidebar-item">
                <a class="sidebar-link" href="{{ route('subscriber.index') }}"> <i class="align-middle"
                        data-feather="bell"></i> <span class="align-middle">subscriber</span> </a>
            </li>
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="{{ route('recycle.index') }}"> <i class="align-middle"
                        data-feather="trash"></i> <span class="align-middle">RecycleBin</span> </a>
            </li>
        </ul>
    </div>
</nav>
