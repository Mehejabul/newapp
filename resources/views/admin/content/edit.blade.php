	...
	<div class="col-12">
		<div class="card border border-secondary">
			...
			<div class="card-body">
				...
				<form method="POST" action="{{ route('content.update',$data->content_slug) }}" enctype="multipart/form-data">
                    @method('put')
                     @csrf
					...
					<div class="row" text-center>
								...
								<div class="mb-3">
									...
									<select type="number" class="form-control @error('page_id') is-invalid @enderror" name="page_id" value="1">
                                        ...
                                        @foreach ($pages as $page)
                                             <option value="{{ $page->page_id }}" @if($page->page_id == $data->page_id) selected @endif>{{ $page->page_name }}</option>
                                        @endforeach
						 ...
						 <div class="col-lg-6 my-2">
							<div class="form-group" >
								<div class="mb-3">
									...
									<input type="text" class="form-control @error('content_title') is-invalid @enderror" name="content_title" value="{{ $data->content_title }}">
                                </div>
                                @error('content_title')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-lg-6  my-2">
							<div class="form-group">
								<div class="mb-3">
									...
									<input type="text" class="form-control @error('content_subtitle') is-invalid @enderror" name="content_subtitle" value="{{ $data->content_subtitle }}">
                                </div>
                        ...
                        <div class="col-lg-4  my-2">
							<div class="form-group">
								<div class="mb-3">
									...
									<input type="file" class="form-control @error('content_image') is-invalid @enderror" id="content_image_input" name="content_image" value="{{ $data->content_image }}">
                                </div>
                           </div>
					    </div>
                        ...
                        <div class="col-lg-2 m-auto">
                            @if($data->content_image)
                               <img id="content_image_preview" src="{{ asset('uploads/content/'.$data->content_image) }}"
                         ...
                         <div class="col-lg-12  my-4">
							<div class="form-group">
								<div class="mb-3">
									...
									<input type="text" class="form-control @error('content_details') is-invalid @enderror" name="content_details" id="editor" value="">
